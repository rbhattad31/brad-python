...
def purchasemonth(in_config):
    try:
        ...
        Month_pd_2 = Q3Sheet[Q3Sheet['Month'].notna()]
        Gr_Amt_pd_2 = Q3Sheet[Q3Sheet['GR Amt.in loc.cur.'].notna()]
        ...
        # Log Sheet
        pivot_sheet.to_excel(in_config["Month_Path"], sheet_name=in_config["MonthSheet"], index=False, startrow=16)
