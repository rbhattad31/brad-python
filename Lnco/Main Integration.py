...
def reading_sheets_names_from_config_main_sheet():
    try:
        config_sheets = {}
        work_book = openpyxl.load_workbook(r'C:\Users\Dell\PycharmProjects\Lnco\Input\Config.xlsx')
        ...
        print(config_error)
        to = "antony.devaraj@bradsol.com"
        cc = "antony.devaraj@bradsol.com"
...
print("Executing Vendor Type Wise Comparitives code")

try:
    config_vendor_comp = reading_sheet_config_data_to_dict(sheet_name=config_sheets_dict["Vendor_Type_Wise_Comparitives_sheetname"])
    vtwc.Create_Vendor_Wise(config_vendor_comp)

except Exception as e:
    print("Exception caught for Process: Vendor type wise comparitives code")
...
try:
    config_vendor_conc = reading_sheet_config_data_to_dict(sheet_name=config_sheets_dict["Vendor_Wise_Concentration_sheetname"])
    vwc.con_vendor_wise(config_vendor_conc)

except Exception as e:
    print("Exception caught for Process: Vendor wise concentration code")
