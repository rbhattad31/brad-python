...
def PurchaseType(in_config):
    try:
        ...
        # Log Sheet
        pivot_sheet.to_excel(in_config["Plant_Path"], sheet_name=in_config["PlantSheet"], index=False)
        print("Plant Wise Comparatives Logged")
